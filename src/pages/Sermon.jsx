...
import { FaDownload, FaLink, FaHeadphonesSimple, FaMagnifyingGlass, FaPlay, FaPause, FaXmark, FaChevronLeft, FaChevronRight } from 'react-icons/fa6';
...
const Sermon = () => {
  ...
  const handlePlay = (sermon) => {
    if (currentAudio && currentAudio !== sermon.audioSource) {
      // Stop current audio if different sermon
      if (audioRef.current) {
    ...
    setCurrentAudio(sermon.audioSource);
    setIsModalOpen(true);
 ...
 {/* Search and Filter Section */}
              ...
              <div className="p-6">
                ...
                <div className="flex justify-start space-x-4">
                  <button
                    ...
                    title="Listen"
                  >
                    <FaHeadphonesSimple className="w-4 h-4" />
                  </button>
                  <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="text-center mb-4">
              <h4 className="font-semibold text-lg">{selectedSermon.title}</h4>
              <p className="text-gray-600">{selectedSermon.sermonDetails.minister}</p>
              <p className="text-sm text-gray-500">{selectedSermon.sermonDetails.bibleText}</p>
            </div>
            ...
            <div className="flex justify-center items-center space-x-4">
              ...
              <button
                onClick={() => handleDownload(selectedSermon)}
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600">{selectedSermon.sermonDetails.sermonNote}</p>
            </div>
          </div>
        </div>
      )}
      ...
      {selectedSermon && (
        <audio
          ref={audioRef}
          src={selectedSermon.audioSource}
